...
function normalizeTarotDetailLevel(detailLevel?: TarotCanonicalTextOptions['detailLevel']): 'default' | 'full' {
  if (detailLevel === 'full' || detailLevel === 'more' || detailLevel === 'facts' || detailLevel === 'debug') {
    return 'full';
  }
  return 'default';
...
function normalizeFortuneDetailLevel(detailLevel?: FortuneCanonicalTextOptions['detailLevel']): 'default' | 'full' {
  if (detailLevel === 'full' || detailLevel === 'more' || detailLevel === 'facts' || detailLevel === 'debug') {
    return 'full';
  }
  return 'default';
...
export function renderFortuneCanonicalJSON(result: FortuneOutput, options: { detailLevel?: FortuneCanonicalTextOptions['detailLevel'] } = {}): FortuneCanonicalJSON {
