...
function normalizeFortuneDetailLevel(detailLevel?: DetailLevel | 'safe' | 'facts' | 'debug'): 'default' | 'full' {
  if (detailLevel === 'full' || detailLevel === 'more' || detailLevel === 'facts' || detailLevel === 'debug') {
    return 'full';
  }
  return 'default';
...
export function renderFortuneCanonicalText(result: FortuneOutput, options: FortuneCanonicalTextOptions = {}): string {
