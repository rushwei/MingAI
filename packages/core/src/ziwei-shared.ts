...
import type { BirthTimeInput, DiZhi, Gender, StarInfo, TrueSolarTimeInfo } from './types.js';

export type { BirthTimeInput, DiZhi, Gender, StarInfo, TrueSolarTimeInfo } from './types.js';
...
function applyMinuteOffsetToSolarDateTime(
  input: { birthYear: number; birthMonth: number; birthDay: number; birthHour: number; birthMinute?: number; },
