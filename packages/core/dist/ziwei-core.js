 ...
 * 紫微斗数排盘核心引擎
 */
import { computeDouJun, computeLiuNianAges, createAstrolabeWithTrueSolar, DI_ZHI, hourToTimeIndex, LUCUN_TABLE, mapStar, MUTAGEN_NAMES, STEM_MUTAGEN_TABLE } from './ziwei-shared.js';
...
// ===== 身主星 =====
const BODY_MASTER_STAR_TABLE = {
    '子': '铃星', '丑': '天相', '寅': '天梁', '卯': '天同',
    '辰': '文昌', '巳': '天机', '午': '铃星', '未': '天相',
    '申': '天梁', '酉': '天同', '戌': '文昌', '亥': '天机',
};
// ===== 小限起始宫（三合局） =====
const SMALL_LIMIT_START = {
    '寅': '辰', '午': '辰', '戌': '辰',
    '申': '戌', '子': '戌', '辰': '戌',
    '巳': '未', '酉': '未', '丑': '未',
    '亥': '丑', '卯': '丑', '未': '丑',
...
/** 计算小限 */
function computeSmallLimit(yearBranch, gender, palaces) {
...
/** 计算三方四正 */
function computeSanFangSiZheng(palaceIdx, palaces) {
    // self, +4 (三合), +8 (三合), +6 (对宫)
    const indices = [
        palaceIdx,
        (palaceIdx + 4) % 12,
