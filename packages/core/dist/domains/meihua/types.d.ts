import type { DerivedHexagramInfo, DetailLevel, DiZhi, GanZhiTime, ResponseFormat, WuXing } from '../shared/types.js';
export type MeihuaMethodFamily = 'classical' | 'extended';
export type MeihuaMethod = 'time' | 'count_with_time' | 'text_split' | 'measure' | 'classifier_pair' | 'select' | 'number_pair' | 'number_triplet';
