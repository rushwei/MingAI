...
// 从数据模块导入静态数据
import { CI_GUAN, DE_XIU, DI_ZHI, DIAO_KE, FEI_REN, FU_XING, GU_CHEN, GUA_SU, GUO_YIN, HIDDEN_STEM_DETAILS, HONG_LUAN, HONG_YAN, HUA_GAI, JIANG_XING, JIE_SHA, JIN_YU, LIU_CHONG, LIU_HE, LIU_HE_HUA, LIU_XIA, LU_SHEN, NA_YIN_TABLE, SAN_HE, SANG_MEN, TAI_JI_GUI_REN, TAO_HUA, TIAN_CHU, TIAN_DE, TIAN_DE_HE, TIAN_GAN, TIAN_XI, TIAN_YI_GUI_REN, WANG_SHEN, WEN_CHANG, XIANG_HAI, XIANG_XING, YANG_REN, YI_MA, YUE_DE, YUE_DE_HE, ZAI_SHA, } from './data/shensha-data.js';
...
export function analyzePillarRelations(yearBranch, monthBranch, dayBranch, hourBranch) {
    const branches = [yearBranch, monthBranch, dayBranch, hourBranch];
