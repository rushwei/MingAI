...
function stripCandidateScore(candidate: RankedYongShenCandidate) {
...
function buildFuShenFallbackCandidate(params: {
  ...
  const kongWangState: KongWangState = kongWang.kongZhi.includes(selectedFuShen.naJia as DiZhi)
    ? 'kong_static'
    : 'not_kong';
