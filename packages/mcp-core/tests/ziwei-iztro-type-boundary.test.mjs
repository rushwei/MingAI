...
const handlerPaths = [
  resolve(process.cwd(), 'packages/mcp-core/src/handlers/ziwei-shared.ts'),
  resolve(process.cwd(), 'packages/mcp-core/src/handlers/ziwei.ts'),
  resolve(process.cwd(), 'packages/mcp-core/src/handlers/ziwei-horoscope.ts'),
  resolve(process.cwd(), 'packages/mcp-core/src/handlers/ziwei-flying-star.ts'),
];
