...
/** 日干寄宫 */
declare const JI_GONG: Record<string, string>;
/** 六冲表 */
declare function liuChong(zhi: string): string;
/** 月将名称 */
declare const YUE_JIANG_NAMES: Record<string, string>;
/** 天将全称 */
declare const TIAN_JIANG_FULL: Record<string, string>;
/**
 * 计算某地支在日干五行下的十二长生状态
 */
...
export declare function getYouDu(_yueJiang: string): string;
interface SiKeData {
    ganYang: string;
    ganYing: string;
    zhiYang: string;
...
export declare function classifyKeTi(method: string, siKe: SiKeData, sanChuan: {
    ...
    zhong: string;
    mo: string;
}, tianPan: Record<string, string>, kongWang: [string, string]): {
    method: string;
    subTypes: string[];
    extraTypes: string[];
};
