...
| 文件 | 说明 |
| --- | --- |
| [conversations 表](/supabase/tabel_export_from_supabase.sql#L25-L41) | 统一对话历史存储 |
| [chat/route.ts](/src/app/api/chat/route.ts) | AI 对话 API |
| [ai.ts](/src/lib/ai.ts) | AI 服务封装 |
...
| 文件 | 说明 |
| --- | --- |
| [ZiweiChartGrid.tsx](/src/components/ziwei/ZiweiChartGrid.tsx) | 紫微命盘网格（含三方四正、文字生成） |
| [PalaceCard.tsx](/src/components/ziwei/PalaceCard.tsx) | 宫位卡片组件 |
| [StarBadge.tsx](/src/components/ziwei/StarBadge.tsx) | 星曜标签组件 |
...
| 文件 | 说明 |
| --- | --- |
| [ProfessionalTable.tsx](/src/components/bazi/result/ProfessionalTable.tsx) | 专业排盘表格（含运势直显） |
| [DiZhiRelations.tsx](/src/components/bazi/result/DiZhiRelations.tsx) | 地支关系组件 |
| [ShenShaSection.tsx](/src/components/bazi/result/ShenShaSection.tsx) | 神煞显示组件 |
| [TenGodKnowledge.tsx](/src/components/bazi/TenGodKnowledge.tsx) | 十神知识库 |
...
| 文件 | 说明 |
| --- | --- |
| [charts/page.tsx](/src/app/user/charts/page.tsx) | 我的命盘页面 |
| [20260112_add_default_chart_ids_to_user_settings.sql](/supabase/migrations/20260112_add_default_chart_ids_to_user_settings.sql) | 数据库迁移 |
...
| 文件 | 说明 |
| --- | --- |
| [NotificationLaunchPanel.tsx](/src/components/admin/NotificationLaunchPanel.tsx) | 通知发布面板 |
| [notification.ts](/src/lib/notification.ts) | 通知服务（含模板定义） |
| [admin/notifications/page.tsx](/src/app/admin/notifications/page.tsx) | 管理员通知页面 |
...
| 文件 | 说明 |
| --- | --- |
| [PaymentPauseOverlay.tsx](/src/components/ui/PaymentPauseOverlay.tsx) | 支付暂停遮罩组件 |
| [payment-status/route.ts](/src/app/api/payment-status/route.ts) | 支付状态 API |
| [20260113_add_app_settings.sql](/supabase/migrations/20260113_add_app_settings.sql) | 数据库迁移 |
...
| [ai-config.ts](/src/lib/ai-config.ts) | AI 模型配置 |
| [models/route.ts](/src/app/api/models/route.ts) | 模型列表 API |
...
| 迁移文件 | 说明 |
| --- | --- |
| [20260112_add_default_chart_ids_to_user_settings.sql](/supabase/migrations/20260112_add_default_chart_ids_to_user_settings.sql) | 用户默认命盘设置 |
| [20260113_add_app_settings.sql](/supabase/migrations/20260113_add_app_settings.sql) | 全局应用配置表 |
