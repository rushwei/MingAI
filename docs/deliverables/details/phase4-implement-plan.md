...
根据 [PRD-MingAI.md](/docs/plans/PRD-MingAI.md) 中定义的 Phase 4 功能需求，制定以下实施计划。
...
#### [MODIFY] [src/lib/fortune.ts](/src/lib/fortune.ts)

- 扩展运势计算支持：时运、爱情、财运、健康、事业、人际关系

#### [MODIFY] [src/app/daily/page.tsx](/src/app/daily/page.tsx)
...
#### [MODIFY] [src/app/monthly/page.tsx](/src/app/monthly/page.tsx)
...
#### [NEW] [src/app/tarot/page.tsx](/src/app/tarot/page.tsx)
...
#### [NEW] [src/app/liuyao/page.tsx](/src/app/liuyao/page.tsx)
