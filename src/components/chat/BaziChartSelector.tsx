...
export function BaziChartSelector({ isOpen, onClose, onSelect, userId, currentSelection, focusType }: ChartSelectorProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-background rounded-xl border border-border shadow-xl w-full max-w-md flex flex-col" style={{ maxHeight: '420px' }}>
                {/* 头部 */}
                <div className="flex items-center justify-between p-4 border-b border-border flex-shrink-0">
                    <h3 className="text-lg font-semibold">选择命盘</h3>
                    <button
                        onClick={onClose}
