...
export function ProfessionalSection({
    ...
    return (
        <div className="space-y-4">
            <section className="bg-background rounded-xl p-4 border border-border overflow-x-hidden max-w-[410px] sm:max-w-none">
            ...
            <section className="bg-background rounded-xl p-4 border border-border max-w-[410px] sm:max-w-none">
