...
interface UnifiedBaziFormProps {
...
export function UnifiedBaziForm({
    formData,
    onUpdate,
    unknownTime,
    onToggleUnknownTime,
            ...
            <form onSubmit={onSubmit} className="bg-background rounded-xl p-4 md:p-6 shadow-sm border border-border/50 space-y-3 mb-5 md:space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="请输入姓名"
                        className="w-full px-3 md:px-4 py-1.5 md:py-2 border border-border rounded-lg bg-background text-sm
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-1.5 md:gap-2">
                            <button
                                ...
                                className={`py-1.5 md:py-2.5 px-1 md:px-2 rounded-lg border text-xs md:text-sm font-medium transition-all duration-200
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-2 md:px-3 py-1.5 md:py-2 border border-border rounded-lg bg-background text-sm
                                        focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent"
                                >
                ...
                {formData.calendarType !== 'pillars' && (
                    <button
                        ...
                        className="w-full flex items-center justify-between p-3 md:p-4 border border-border rounded-lg
                    ...
                    >
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <span className="text-xs md:text-sm font-medium">出生时间</span>
                ...
                <button
                    ...
                    className="w-full py-2 md:py-3 bg-accent text-white rounded-lg text-sm md:text-base font-medium
                ...
                {/* 免责声明 */}
                <p className="text-[10px] md:text-xs text-center text-foreground-tertiary">
                    八字排盘仅供参考，不构成任何建议
                </p>
            </form>
